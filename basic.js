        ...
        if (event.message && !event.message.is_echo) {
          ...
          if (attachments) {
            ...
            wit.message(text).then(({entities}) => {
              ...
              let qs = unit + '-' + currency;

              return fetch('https://api.cryptonator.com/api/ticker/' + qs, {
                    method: 'GET',
                    headers: {'Content-Type': 'application/json'},
                })
                .then(rsp => rsp.json())
                .then(json => {
                    ...
                    let price = json.ticker.price;
                    let result = price * amount_of_money;
                    return fbMessage(sender, result);
                });
